  ...
  brunch: [
    {
      id: 'pelle-and-pepe',
      name: 'Pelle and Pepe',
      description: 'Classic brunch with great pasta and breakfast fare.',
    ...
    },
    {
      id: 'marlows-deli',
      name: "Marlow's Deli",
      description: 'Cozy deli with a delicious New York-style brunch menu.',
  ...
  snack: [
    {
      id: 'bee-hoe-coffee',
      name: 'Bee Hoe Coffee',
      description: 'A cozy café perfect for a sweet snack or coffee break.',
    ...
    },
    {
      id: 'cata-coffee',
      name: 'Cata Coffee',
      description: 'A relaxed spot for coffee and light bites.',
  ...
  dinner: [
    {
      ...
      description: 'Specialty tempura dinner for a refined evening.',
    ...
    },
    {
      id: 'tutto',
      name: 'Tutto (Italian)',
      description: 'Italian dinner with comforting pasta and wine.',
    ...
    },
    {
      ...
      description: 'Unique Peranakan flavors for a memorable dinner experience.',
